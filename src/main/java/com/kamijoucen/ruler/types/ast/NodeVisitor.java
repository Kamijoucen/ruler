...
public interface NodeVisitor<T> {
    ...
    default T eval(BaseNode node, Scope scope, RuntimeContext context) {
        return node == null ? null : node.accept(this, scope, context);
    }

    T eval(VirtualNode node, Scope scope, RuntimeContext context);
